...
from src.llm.agents.common.tools.formula_tools import (
    LOCAL_FORMULA_TOOLS,
)
...
# monitoring/simulation/execution primitives, the cross-agent alert action
# plan tools, and the stored business rules.
COMMON_TOOLS = {
    **LOCAL_FREEFORM_QUERY_TOOLS,
    **LOCAL_MONITORING_TOOLS,
    **COMMON_ALERT_ACTION_TOOLS,
